...
caption <- "Visualization: Cedric Scherer  •  Data: GISTEMP (country-level data prepared by Antti Lipponen)"
```
...
facet_asia <-
  ...
  ggplot(aes(year, 1)) +
    ...
    theme(legend.position = "top",
          ...
          plot.title = element_text(size = 36, margin = margin(t = 10, b = 10)),
          plot.subtitle = element_text(size = 16, margin = margin(t = 0, b = 15)),
          plot.caption = element_text(size = 9, margin = margin(t = -10, b = 0)),
          plot.margin = margin(15, 25, 15, 25),
          strip.text = element_text(color = "grey60", margin = margin(rep(0, 4))))
  ...
  ggplot(aes(year, 1)) +
    ...
    scale_fill_distiller(palette = "RdBu", direction = -1, 
                         ...
                         labels = function(x) if_else(abs(x) == 1.5, 
                                                      ...
                                                      paste0(format(x, nsmall = 2)))) + 
    guides(fill = guide_bins(axis = FALSE)) +
    labs(title = "The Americas is Getting Warmer",
...
facet_oceania <-
  ...
  ggplot(aes(year, 1)) +
    ...
    theme(legend.position = "top",
          ...
          plot.caption = element_text(size = 9, margin = margin(t = -10, b = 0)),
          plot.margin = margin(15, 25, 15, 25),
          strip.text = element_text(color = "grey60", size = 18,
